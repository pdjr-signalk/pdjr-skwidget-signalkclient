...
processing by any defined _filter_.

#### Example
```
var level = signalkClient.getValueSync("tanks.fuel.3");
```
...
properties can be extracted by the consumer.
...
### SignalkClient.httpGetSync(_url_)

Return the document returned by an HTTP GET on _url_, or null
